...
<!--            <ul class="dropdown-menu hamburger-dropdown-menu">
                <li class="more-menu"><a href="adminUserList.jsp">1. User List</a></li>
                <li class="more-menu"><a href="adminWordFilter.jsp">2. Word Filter</a></li>
                <li class="more-menu"><a href="adminPostManagement.jsp">3. Post Management</a></li>
            </ul>
-->        </div>
    </div>
